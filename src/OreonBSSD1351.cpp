...
/********** IMAGES **********/
void OreonBSSD1351::drawBitmap(int16_t x, int16_t y, int16_t w, int16_t h, const uint8_t bitmap[] PROGMEM, int32_t color, int32_t background, float scale, bool yx) {
